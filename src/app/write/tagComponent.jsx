...
//                     .map(cate => {
//                         const tagsForCate = tag.filter(t =>
//                             Number(t.cate_idx) === Number(cate.cate_idx) &&
//                             (t.isClass?.toLowerCase?.() === 'course')
//                         );
//                         console.log('카테고리:', cate.cate_name, ' / 포함된 태그 수:', tagsForCate.length, tagsForCate);
//                         return (
